...
//  KLine
//
//  Created by work on 2025/3/29.
//

import UIKit

class KLineItemView: UIView {
    ...
    private func update() {
        ...
        let prefix = changeRateString.hasPrefix("-") ? "" : "+"
        ...
        amplitudeLabel.detailLabel.text = styleManager.format(value: amplitude)
        // 成交量
